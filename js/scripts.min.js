...
$(function(){$(".navigation .top-nav a").mPageScroll2id(),$("header .buttons").mPageScroll2id(),$("footer .up-button").mPageScroll2id(),$(document).on("click",".hamburger",function(){$(this).toggleClass("open"),$(".toggle-nav").slideToggle()})});
